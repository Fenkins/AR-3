const fs = require('fs');
const content = fs.readFileSync('/opt/AR-3/app/api/spaces/[id]/route.ts', 'utf8');
const old = `      case 'stop':
...
if (content.includes(old)) {
    fs.writeFileSync('/opt/AR-3/app/api/spaces/[id]/route.ts', content.replace(old, newBlock));
    console.log('Patched');
} else {
