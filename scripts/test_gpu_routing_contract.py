...
def test_investigation_default_stage_can_stay_conceptual_but_routes_by_policy():
    ...
    assert "'Investigation'" in _routed_block()
...
if __name__ == "__main__":
    ...
    test_investigation_default_stage_can_stay_conceptual_but_routes_by_policy()
