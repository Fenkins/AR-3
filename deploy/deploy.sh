...
if [ -z "$API_KEY" ]; then
    echo "❌ VAST_API_KEY environment variable is required"
    exit 1
fi
...
echo "  Password: set ADMIN_PASSWORD before running npm run seed"
echo ""
echo "Set a unique password for every deployment."
echo "================================================================"
